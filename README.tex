...
\begin{table}[!ht]
    ...
    \begin{tabular}{c|c|c|c}
        ...
        1.20.x & 3.2.2 & Fabric & \href{https://github.com/lihugang/mtr-cr-speed-rails/releases/download/MTR3.2.2/MTR3.2.2-Fabric-1.20.x-Java17.jar}{MTR3.2.2-Fabric-1.20.x-Java17.jar} \\
    \end{tabular}
    \caption{版本列表}
\end{table}
\end{document}
