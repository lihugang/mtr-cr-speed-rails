...
\begin{itemize}
    ...
    \item 新增的单向轨道无法保存在存档中 (已移除全部单向轨道，仅 MTR3.2.2 - Fabric - Minecraft 1.20.x - Java17)
    \item 在创造模式下，MTR 新增的物品会全部堆到“红石物品”下 (仅 MTR3.2.2 - Fabric - Minecraft 1.20.x - Java17)
\end{itemize}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{c|c|c|c}
        ...
        1.20.1 & 3.2.2 & Fabric & \href{https://github.com/lihugang/mtr-cr-speed-rails/releases/download/MTR3.2.2/MTR3.2.2-Fabric-1.20.x-Java17.jar}{MTR3.2.2-Fabric-1.20.x-Java17.jar} \\
    \end{tabular}
    \caption{版本列表}
\end{table}
\end{document}
